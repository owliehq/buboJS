...
export abstract class BuboRepository<ModelType, ModelData = ModelType>{
     ...
     * @param any options that should be specified by the service itself
     */
    abstract findOneByNoThrow<Key extends keyof ModelData>(key: Key, value: ModelData[Key], ...any): Promise<ModelType | null | undefined>
     ...
     * @param any options that should be specified by the service itself
     */
    abstract getOne(pk: string, ...any): Promise<ModelType>

    /**
     * Get all models instances according to th optional given options
     * @param any options that should be specified by the service itself
     */
    abstract getMany(...any): Promise<Array<ModelType>>
}